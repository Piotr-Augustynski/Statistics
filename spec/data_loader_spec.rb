...
describe DataLoader do
  let(:json) { DataLoader.new(File.join(File.dirname(__FILE__), 'files', 'data.json')).call }
  let(:csv) { DataLoader.new(File.join(File.dirname(__FILE__), 'files', 'data.csv')).call }
